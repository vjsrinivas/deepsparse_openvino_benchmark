...
if __name__ == "__main__":
    ...
    # model setup:
    model = timm.create_model('mobilevit_xxs.cvnets_in1k', pretrained=True, exportable=True)
    export_onnx(model, export_path=os.path.join(exp_export_path, "mobilevit-xxs-imagenet-base.onnx"))
    ...
    # training hyp
    PATH_TO_RECIPE = "mobilevit_xxs_layer.yaml"
    LR = 0.01
    ...
    export_onnx(model, export_path=os.path.join(exp_export_path, "mobilevit-xxs-imagenet-pruned.onnx"))