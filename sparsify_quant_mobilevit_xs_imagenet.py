...
if __name__ == "__main__":
    ...
    # model setup:
    model = timm.create_model('mobilevit_xs.cvnets_in1k', pretrained=True, exportable=True)
    export_onnx(model, export_path=os.path.join(exp_export_path, "mobilevit-xs-imagenet-base.onnx"))
